...
export class InMemoryDatabase implements InMemoryDbService {
  createDb() {
    ...
    const entries: Entry[] = [
      ...
      { id: 11, name: 'Salário', description: 'Empresa X', categoryId: categories[1].id, category: categories[1], paid: true, date: '14/05/2019', amount: '4500,00', type: 'renevue' } as Entry
    ];
